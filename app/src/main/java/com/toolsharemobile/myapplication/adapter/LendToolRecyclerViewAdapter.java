...
public class LendToolRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (toolList.get(position).getToolType().equals(ToolTypeEnum.CROWBAR))
            imageViewToolIcon.setImageResource(R.drawable.crowbar);
        if (toolList.get(position).getToolType().equals(ToolTypeEnum.SLEDGEHAMMER))
            imageViewToolIcon.setImageResource(R.drawable.sledgehammer);
        if (toolList.get(position).getToolType().equals(ToolTypeEnum.DRILL))
            imageViewToolIcon.setImageResource(R.drawable.drill);
        if (toolList.get(position).getToolType().equals(ToolTypeEnum.CIRCULARSAW))
            imageViewToolIcon.setImageResource(R.drawable.circular_saw);
        if (toolList.get(position).getToolType().equals(ToolTypeEnum.JIGSAW))
            imageViewToolIcon.setImageResource(R.drawable.jigsaw);
